...
class ControllerPaymentPayerinvoice extends Controller {

	private $error = array();
	private $pname = 'payer_invoice';
	...
	public function index() {
		...
		$this->response->setOutput($this->load->view('payment/payer_invoice.tpl', $data));
	}
