...
class ControllerPaymentPayereinvoice extends Controller {

	private $error = array();
	private $pname = 'payer_einvoice';
	...
	public function index() {
		...
		$this->response->setOutput($this->load->view('payment/payer_einvoice.tpl', $data));
	}
