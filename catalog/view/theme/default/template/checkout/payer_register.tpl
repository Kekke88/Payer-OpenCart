<?php
/***************
PAYER Fast checkout counter script
Script includes fast checkout receive consumer name, adress etc.
*/
require_once(DIR_APPLICATION . "controller/payment/payerapi/payread_post_api.php");
include_once(DIR_APPLICATION . "controller/payment/payerapi/payer_plugin.php");
$payerplugin = new payer_plugin();
$script = $payerplugin->getFastCheckoutScript('opencart');
/***************************/
?>
<?=$script?>
<div class="left">
  <h2><?php echo $text_your_details; ?></h2>
  <span class="required">*</span> Personal identity number<br />
  <input type="text" name="persnumber" value="" class="large-field" id="payer_inp_pin" />
  <a id="payer_btn_pin" class="button"><span>H&auml;mta adress</span></a>
  <br />
  <br />
